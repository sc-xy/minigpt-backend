...
import com.xy.springboot.annotation.AuthCheck;
...
import com.xy.springboot.constant.UserConstant;
import com.xy.springboot.exception.BusinessException;
import com.xy.springboot.exception.ThrowUtils;
import com.xy.springboot.model.dto.user.UserLoginRequest;
import com.xy.springboot.model.dto.user.UserRegisterRequest;
import com.xy.springboot.model.dto.user.UserUpdateRequest;
import com.xy.springboot.model.entity.User;
import com.xy.springboot.model.vo.LoginUserVO;
import com.xy.springboot.model.vo.UserVO;
...
public class UserController {
    ...
    public BaseResponse<Boolean> updateUser(@RequestBody UserUpdateRequest userUpdateRequest,
        ...
        User user = userService.checkOldPassword(userUpdateRequest.getId(), userUpdateRequest.getUserAccount(),
                oldPassword);
